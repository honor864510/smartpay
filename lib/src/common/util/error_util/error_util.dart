...
import 'package:smartpay/src/common/util/error_util/platform/error_util_vm.dart'
    // ignore: uri_does_not_exist
    if (dart.library.html) 'package:smartpay/src/common/util/error_util/platform/error_util_js.dart';
